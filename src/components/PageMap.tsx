...
import { BookOpenText, TvMinimalPlay, FileText, Folder, BookText } from "lucide-react";
      ...
      ({ name, route, title, type, children, frontMatter }: ServiceProps) => (
        ...
        <CardHeader className="flex-1">
          ...
          {frontMatter?.icon || (() => {
            ...
            switch (type) {
            case 'doc': return <FileText />; // book
            case 'page': return <BookText />; // folder
            case 'guide': return <TvMinimalPlay />; // video
            default: return <FileText />; // article
            }
          })()}
          </Button>
          <div className="mt-3">
          ...
          <CardDescription className="text-sm">
            <div className="mt-2 overflow-hidden text-ellipsis line-clamp-2 min-h-[40px]">
